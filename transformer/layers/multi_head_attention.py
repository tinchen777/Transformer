...
class ScaledDotProductAttention_1(nn.Module):
    ...
    def forward(self, Q: Tensor, K: Tensor, V: Tensor, attn_mask: Optional[Tensor] = None):
        """
...
class MultiHeadAttention_1(nn.Module):
    ...
    def forward(self, input_Q: Tensor, input_K: Tensor, input_V: Tensor, attn_mask: Optional[Tensor] = None):
        """
...
# IMPLEMENT 2
# ###########
class ScaleDotProductAttention_2(nn.Module):
    """
...
class MultiHeadAttention_2(nn.Module):
    def __init__(self, d_model, n_head):
        super().__init__()
        self.n_head = n_head
        self.attention = ScaleDotProductAttention_2()
    ...
    def concat(self, tensor):
        """
        inverse function of self.split(tensor : Tensor)
