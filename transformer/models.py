...
class Transformer(TransformerBase):
    ...
    def generate(
        ...
        try:
            ...
            # ========== 1. Encoder==========
            src_mask = self.encoder.make_padding_mask(prompt)  # [1, 1, 1, len_prompt]
    ...
    def forward(
        ...
        trg_padding_mask: Optional[Tensor] = None,
        trg_causal_mask: Optional[Tensor] = None
    ) -> Tensor:
        """
        ...
        ----------
            ...
            src_padding_mask : Optional[Tensor]
                The source padding mask, shape as `[bsz, 1, 1, len_src]`.
                - `None`: The source padding mask will be generated by the encoder itself using the `make_padding_mask` method.

            trg_padding_mask : Optional[Tensor]
                The target padding mask, shape as `[bsz, 1, 1, len_trg]`.
                - `None`: The target padding mask will be generated by the decoder itself using the `make_padding_mask` method.

            trg_causal_mask : Optional[Tensor]
                The target causal mask, shape as `[len_trg, len_trg]`.
                - `None`: The target causal mask will be generated by the decoder itself using the `make_causal_mask` method.
        ...
        """
        enc_outputs = self.encoder(src, src_padding_mask=src_padding_mask)
        dec_outputs = self.decoder(
            trg, enc_outputs,
            src_padding_mask=self.encoder.src_padding_mask, trg_padding_mask=trg_padding_mask,
    ...
    def forward(
        ...
        ----------
            ...
            padding_mask : Optional[Tensor]
                The padding mask, shape as `[bsz, 1, 1, len_trg]`.
                - `None`: The padding mask will be generated by the decoder itself using the `make_padding_mask` method.

            causal_mask : Optional[Tensor]
                The causal mask, shape as `[len_trg, len_trg]`.
                - `None`: The target causal mask will be generated by the decoder itself using the `make_causal_mask` method.
